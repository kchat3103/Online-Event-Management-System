...
// checking in the database whether entred details are present.
...
// removing the venues from user database if the last date of booking is passed
var t = new Date();
...
app.post("/view", async function (req, res) {
  // adding the start and end date of venue booking in venue table after the user selects a venue
...
app.post("/deselect", async function (req, res) {
  // updating the table if the user deselects a venue
...
app.post("/delete_venue", async function (req, res) {
  // deleting the venue after the owner of the place makes change
...
app.post("/update_venue", async function (req, res) {
  ...
  // updating some fields of a venue if the owner need to make changes
...
app.post("/addVenue", async (req, res) => {
  ...
  // creating an entry of the venue in the venues table after owner applies for it
...
app.post("/signup_owner", async (req, res) => {
  ...
  // creating the new owner on signup
